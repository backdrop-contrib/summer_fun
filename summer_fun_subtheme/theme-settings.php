...
$form['summer_fun_subtheme_juiced_main_background'] = array(
      '#type' => 'textarea',
      '#title' => t('Enter the URL to your desired background image for the main page area when you are using a Juiced layout'),
      '#default_value' => theme_get_setting('summer_fun_subtheme_juiced_main_background', 'summer_fun_subtheme'),
    );

$form['summer_fun_subtheme_juiced_main_background_blurred'] = array(
      '#type' => 'checkbox',
      '#title' => t('Blur this background'),
      '#default_value' => theme_get_setting('summer_fun_subtheme_juiced_main_background_blurred', 'summer_fun_subtheme'),
    );

$form['summer_fun_subtheme_juiced_big_statement_background'] = array(
      '#type' => 'textarea',
      ...
      '#default_value' => theme_get_setting('summer_fun_subtheme_juiced_big_statement_background', 'summer_fun_subtheme'),
    );

$form['summer_fun_subtheme_juiced_big_statement_background_blurred'] = array(
      '#type' => 'checkbox',
      '#title' => t('Blur this background'),
      '#default_value' => theme_get_setting('summer_fun_subtheme_juiced_big_statement_background_blurred', 'summer_fun_subtheme'),
    );

$form['summer_fun_subtheme_body_main_background'] = array(
      '#type' => 'textarea',
      '#title' => t('Enter the URL to your desired background image for the main page area in a core layout.'),
      '#default_value' => theme_get_setting('summer_fun_subtheme_body_main_background', 'summer_fun_subtheme'),
    );

$form['summer_fun_subtheme_body_main_background_blurred'] = array(
      '#type' => 'checkbox',
      '#title' => t('Blur this background'),
      '#default_value' => theme_get_setting('summer_fun_subtheme_body_main_background_blurred', 'summer_fun_subtheme'),
    );

$form['summer_fun_subtheme_footer_main_background'] = array(
      '#type' => 'textarea',
      '#title' => t('Enter the URL to your desired background image for the footer area in a core layout.'),
      '#default_value' => theme_get_setting('summer_fun_subtheme_footer_main_background', 'summer_fun_subtheme'),
    );

$form['summer_fun_subtheme_footer_main_background_blurred'] = array(
      '#type' => 'checkbox',
      '#title' => t('Blur this background'),
      '#default_value' => theme_get_setting('summer_fun_subtheme_footer_main_background_blurred', 'summer_fun_subtheme'),
    );
