...
/**
 * @file
 * Summer Fun sub theme template functions
 *
*/
 ...
 */
function summer_fun_subtheme_preprocess_maintenance_page(&$variables) {
 ...
 */
function summer_fun_subtheme_preprocess_page(&$variables) {

$current_layout_obj = layout_get_layout_by_path();
$current_layout = $current_layout_obj->name;
$uses_admin_width = config_get('summer_fun_subtheme.settings', 'use_max_width');
  if ($uses_admin_width) {

    $uses_layout_width1 = config_get('summer_fun_subtheme.settings', 'max_width_element1');
    if ($uses_layout_width1 < 1) {
      $max_width_layouts1 = config_get('summer_fun_subtheme.settings', 'site_layouts1');
      $max_width_number1 = config_get('summer_fun_subtheme.settings', 'max_width_number1');
    ...
    $uses_layout_width2 = config_get('summer_fun_subtheme.settings', 'max_width_element2');
    if ($uses_layout_width2 < 1) {
      $max_width_layouts2 = config_get('summer_fun_subtheme.settings', 'site_layouts2');
      $max_width_number2 = config_get('summer_fun_subtheme.settings', 'max_width_number2');
    ...
    $uses_layout_width3 = config_get('summer_fun_subtheme.settings', 'max_width_element3');
    if ($uses_layout_width3 < 1) {
      $max_width_layouts3 = config_get('summer_fun_subtheme.settings', 'site_layouts3');
      $max_width_number3 = config_get('summer_fun_subtheme.settings', 'max_width_number3');
...
function summer_fun_subtheme_preprocess_layout(&$variables) {
...
// backgrounds
// body region
$var1 = theme_get_setting('body_main_background', 'summer_fun_subtheme');
$var2 = theme_get_setting('body_main_background_retina', 'summer_fun_subtheme');
$var3 = theme_get_setting('body_main_background_blurred', 'summer_fun_subtheme');
...
// calltoaction region
$var1 = theme_get_setting('footer_main_background', 'summer_fun_subtheme');
$var2 = theme_get_setting('footer_main_background_retina', 'summer_fun_subtheme');
$var3 = theme_get_setting('footer_main_background_blurred', 'summer_fun_subtheme');
...
// juiced_main region
$var1 = theme_get_setting('juiced_main_background', 'summer_fun_subtheme');
$var2 = theme_get_setting('juiced_main_background_retina', 'summer_fun_subtheme');
$var3 = theme_get_setting('juiced_main_background_blurred', 'summer_fun_subtheme');
...
// statement1 region
$var1 = theme_get_setting('statement1_background', 'summer_fun_subtheme');
$var2 = theme_get_setting('statement1_background_retina', 'summer_fun_subtheme');
$var3 = theme_get_setting('statement1_background_blurred', 'summer_fun_subtheme');
...
// statement2 region
$var1 = theme_get_setting('statement2_background', 'summer_fun_subtheme');
$var2 = theme_get_setting('statement2_background_retina', 'summer_fun_subtheme');
$var3 = theme_get_setting('statement2_background_blurred', 'summer_fun_subtheme');
...
// statement3 region
$var1 = theme_get_setting('statement3_background', 'summer_fun_subtheme');
$var2 = theme_get_setting('statement3_background_retina', 'summer_fun_subtheme');
$var3 = theme_get_setting('statement3_background_blurred', 'summer_fun_subtheme');
...
backdrop_add_js("themes/summer_fun_subtheme/js/scripts.js", array('type' => 'file', 'scope' => 'footer', 'every_page' => TRUE, 'preprocess' => TRUE));
 ...
 */
function summer_fun_subtheme_field__taxonomy_term_reference($variables) {
  $output = '';
 ...
 */
function summer_fun_subtheme_preprocess_image_style(&$vars) {
  $vars['attributes']['class'][] = 'pure-img';
}

function summer_fun_subtheme_button(&$vars) {
...
function summer_fun_subtheme_css_alter(&$css) {
  $css_to_remove = array();
  if (theme_get_setting('summer_fun_subtheme_cdn') > 0)
  {
  $css_to_remove[] = backdrop_get_path('theme','summer_fun') . '/css/pure.min.css';
  }

  if (theme_get_setting('sass') > 0)
  {
  $css_to_remove[] = backdrop_get_path('theme','summer_fun') . '/css/style.css';
  $css_to_remove[] = backdrop_get_path('theme','summer_fun') . '/css/pure.min.css';
  }
 ...
 */
function summer_fun_subtheme_form_alter(&$form, &$form_state, $form_id) {
...
function summer_fun_subtheme_menu_tree($variables) {
 ...
 */
function summer_fun_subtheme_form_element_label(&$variables) {
 ...
 */
function summer_fun_subtheme_menu_link(array $variables) {
$element = $variables['element'];
