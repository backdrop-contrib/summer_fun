...
if (theme_get_setting('summer_fun_subtheme_script1') > 0)
{
...
if (theme_get_setting('summer_fun_subtheme_script2') > 0)
{
...
if (theme_get_setting('summer_fun_subtheme_script3') > 0)
{
...
if (theme_get_setting('summer_fun_subtheme_script4') > 0)
{
...
function summer_fun_subtheme_css_alter(&$css) {
  ...
  if (theme_get_setting('summer_fun_subtheme_sass') > 0)
  {
