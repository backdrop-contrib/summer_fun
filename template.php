...
/**
 * @file
 * Summer Fun parent theme template functions
 *
*/
 ...
 */
function summer_fun_preprocess_maintenance_page(&$variables) {
 ...
 */
function summer_fun_preprocess_page(&$variables) {


$current_layout = "default";
$uses_admin_width = config_get('summer_fun.settings', 'use_max_width');
  if ($uses_admin_width) {

    $uses_layout_width1 = config_get('summer_fun.settings', 'max_width_element1');
    if ($uses_layout_width1 < 1) {
      $max_width_layouts1 = config_get('summer_fun.settings', 'site_layouts1');
      $max_width_number1 = config_get('summer_fun.settings', 'max_width_number1');
    ...
    $uses_layout_width2 = config_get('summer_fun.settings', 'max_width_element2');
    if ($uses_layout_width2 > 0) {
      $max_width_layouts2 = config_get('summer_fun.settings', 'site_layouts2');
      $max_width_number2 = config_get('summer_fun.settings', 'max_width_number2');
    ...
    $uses_layout_width3 = config_get('summer_fun.settings', 'max_width_element3');
    if ($uses_layout_width3 > 0) {
      $max_width_layouts3 = config_get('summer_fun.settings', 'site_layouts3');
      $max_width_number3 = config_get('summer_fun.settings', 'max_width_number3');
...
function summer_fun_preprocess_layout(&$variables) {
...
// backgrounds
// body region
$var1 = theme_get_setting('summer_fun_body_main_background', 'summer_fun');
$var2 = theme_get_setting('summer_fun_body_main_background_retina', 'summer_fun');
$var3 = theme_get_setting('summer_fun_body_main_background_blurred', 'summer_fun');
...
// calltoaction region
$var1 = theme_get_setting('summer_fun_footer_main_background', 'summer_fun');
$var2 = theme_get_setting('summer_fun_footer_main_background_retina', 'summer_fun');
$var3 = theme_get_setting('summer_fun_footer_main_background_blurred', 'summer_fun');
...
// juiced_main region
$var1 = theme_get_setting('summer_fun_juiced_main_background', 'summer_fun');
$var2 = theme_get_setting('summer_fun_juiced_main_background_retina', 'summer_fun');
$var3 = theme_get_setting('summer_fun_juiced_main_background_blurred', 'summer_fun');
...
// statement1 region
$var1 = theme_get_setting('summer_fun_statement1_background', 'summer_fun');
$var2 = theme_get_setting('summer_fun_statement1_background_retina', 'summer_fun');
$var3 = theme_get_setting('summer_fun_statement1_background_blurred', 'summer_fun');
...
// statement2 region
$var1 = theme_get_setting('summer_fun_statement2_background', 'summer_fun');
$var2 = theme_get_setting('summer_fun_statement2_background_retina', 'summer_fun');
$var3 = theme_get_setting('summer_fun_statement2_background_blurred', 'summer_fun');
...
// statement3 region
$var1 = theme_get_setting('summer_fun_statement3_background', 'summer_fun');
$var2 = theme_get_setting('summer_fun_statement3_background_retina', 'summer_fun');
$var3 = theme_get_setting('summer_fun_statement3_background_blurred', 'summer_fun');
 ...
 */
function summer_fun_field__taxonomy_term_reference($variables) {
  $output = '';
...
function summer_fun_css_alter(&$css) {
  if (theme_get_setting('summer_fun_cdn') > 0)
  {
  $css_to_remove = array();
