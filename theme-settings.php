...
$form['summer_fun_backgrounds']['body_main_background'] = array(
      ...
      '#default_value' => theme_get_setting('body_main_background', 'summer_fun'),
    );
...
$form['summer_fun_backgrounds']['body_main_background_retina'] = array(
      ...
      '#default_value' => theme_get_setting('body_main_background_retina', 'summer_fun'),
    );

$form['summer_fun_backgrounds']['body_main_background_blurred'] = array(
      '#type' => 'checkbox',
      '#title' => t('Blur this background'),
      '#default_value' => theme_get_setting('body_main_background_blurred', 'summer_fun'),
    );
...
$form['summer_fun_backgrounds']['footer_main_background'] = array(
      ...
      '#default_value' => theme_get_setting('footer_main_background', 'summer_fun'),
    );
...
$form['summer_fun_backgrounds']['footer_main_background_retina'] = array(
      ...
      '#default_value' => theme_get_setting('footer_main_background_retina', 'summer_fun'),
    );

$form['summer_fun_backgrounds']['footer_main_background_blurred'] = array(
      '#type' => 'checkbox',
      '#title' => t('Blur this background'),
      '#default_value' => theme_get_setting('footer_main_background_blurred', 'summer_fun'),
    );
...
$form['summer_fun_backgrounds']['juiced_main_background'] = array(
      ...
      '#default_value' => theme_get_setting('juiced_main_background', 'summer_fun'),
    );
...
$form['summer_fun_backgrounds']['juiced_main_background_retina'] = array(
      ...
      '#default_value' => theme_get_setting('juiced_main_background_retina', 'summer_fun'),
    );

$form['summer_fun_backgrounds']['juiced_main_background_blurred'] = array(
      '#type' => 'checkbox',
      '#title' => t('Blur this background'),
      '#default_value' => theme_get_setting('juiced_main_background_blurred', 'summer_fun'),
    );
...
$form['summer_fun_backgrounds']['statement1_background'] = array(
      ...
      '#default_value' => theme_get_setting('statement1_background', 'summer_fun'),
    );
...
$form['summer_fun_backgrounds']['statement1_background_retina'] = array(
      ...
      '#default_value' => theme_get_setting('statement1_background_retina', 'summer_fun'),
    );

$form['summer_fun_backgrounds']['statement1_background_blurred'] = array(
      '#type' => 'checkbox',
      '#title' => t('Blur this background'),
      '#default_value' => theme_get_setting('statement1_background_blurred', 'summer_fun'),
    );
...
$form['summer_fun_backgrounds']['statement2_background'] = array(
      ...
      '#default_value' => theme_get_setting('statement2_background', 'summer_fun'),
    );
...
$form['summer_fun_backgrounds']['statement2_background_retina'] = array(
      ...
      '#default_value' => theme_get_setting('statement2_background_retina', 'summer_fun'),
    );

$form['summer_fun_backgrounds']['statement2_background_blurred'] = array(
      '#type' => 'checkbox',
      '#title' => t('Blur this background'),
      '#default_value' => theme_get_setting('statement2_background_blurred', 'summer_fun'),
    );
...
$form['summer_fun_backgrounds']['statement3_background'] = array(
      ...
      '#default_value' => theme_get_setting('statement3_background', 'summer_fun'),
    );
...
$form['summer_fun_backgrounds']['statement3_background_retina'] = array(
      ...
      '#default_value' => theme_get_setting('statement3_background_retina', 'summer_fun'),
    );

$form['summer_fun_backgrounds']['statement3_background_blurred'] = array(
      '#type' => 'checkbox',
      '#title' => t('Blur this background'),
      '#default_value' => theme_get_setting('statement3_background_blurred', 'summer_fun'),
    );
